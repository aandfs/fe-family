        ...
        <tbody>
            @foreach ($family as $n)
                <tr>
                    ...
                    <td>{{ $n['fl_relation'] }}</td>
                    <td>
                        <a href="/admin/nationalities/{{ $n['fl_id'] }}" class="badge bg-info"><i class="fas fa-eye"></i></a>
                        <a href="/admin/nationalities/{{ $n['fl_id'] }}/edit" class="badge bg-warning"><i class="fas fa-edit"></i></a>
                        <form action="/admin/nationalities/{{ $n['fl_id'] }}" method="POST" class="d-inline">
                            @method('delete')
                            @csrf
